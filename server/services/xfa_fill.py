...
ALIASES = {
    ...
    'placebirthcountry':    ['country_of_birth', 'countryOfBirth'],
    'citizenship':          ['nationality', 'citizenship', 'country_of_citizenship'],
    'countryofresidence':   ['countryOfResidence', 'country_of_residence'],
    'immigrationstatus':    ['residenceStatus', 'residence_status'],
    'passportnum':          ['passport_number', 'passportNumber', 'passport_no'],
    'countryofissue':       ['passportCountry', 'passport_country'],
    'nativelang':           ['nativeLanguage', 'native_language', 'nativeLanguageAbility'],
    'sex':                  ['sex', 'gender'],
    'maritalstatus':        ['marital_status', 'maritalStatus'],
    'email':                ['email', 'email_address'],
    'phone':                ['phone', 'telephone', 'mobile'],
    'fax':                  ['faxNumber', 'fax_number'],
    'currentmailingaddress':['currentAddress', 'address', 'mailing_address'],
    'residentialaddress':   ['residentialAddress', 'residential_address'],
    'aptunit':              ['currentAddress'],
    'city':                 ['currentCity', 'current_city'],
    'provstate':            ['currentProvince', 'current_province'],
    'postalcode':           ['currentPostalCode', 'current_postal_code'],
    'country':              ['currentCountry', 'current_country'],
    'occupation':           ['currentOccupation', 'occupation', 'job_title', 'profession'],
    'employer':             ['currentEmployer', 'current_employer'],
    'intendedoccupation':   ['intendedOccupation', 'intended_occupation'],
    'education':            ['highestEducation', 'highest_education'],
    'eyecolour':            ['eyeColour', 'eye_colour', 'eye_color'],
    'height':               ['height'],
    'visatype':             ['purposeOfVisit', 'visa_type', 'purpose_of_visit'],
    'purposeofvisit':       ['purposeOfVisit', 'purpose_of_visit'],
    'fundstripamount':      ['fundsAvailable', 'funds_available'],
    'howlongstay':          ['stayDuration', 'stay_duration'],
    'servicein':            ['preferred_language'],
    'aliasfamilyname':      ['aliasFamilyName', 'alias_last_name'],
    'aliasgivenname':       ['aliasGivenName', 'alias_first_name'],
    ...
    'nationalid':           ['nationalIdentityNumber', 'national_identity_number'],
    'uscitizen':            ['usCitizenOrPR', 'us_citizen_or_pr'],
    'contactname':          ['contactInCanadaName', 'contact_in_canada_name'],
    'contactrelationship':  ['contactInCanadaRelation', 'contact_in_canada_relation'],
    'contactaddress':       ['contactInCanadaAddress', 'contact_in_canada_address'],
}
...
CONTEXT_ALIASES = {
    ...
    ('MaritalStatus', 'Citizenship'):   ['spouseNationality', 'spouse_nationality'],
    ('MaritalStatus', 'PassportNum'):   ['spousePassportNumber', 'spouse_passport_number'],
    ('MaritalStatus', 'PlaceBirthCountry'): ['spouseCountryOfBirth', 'spouse_country_of_birth'],
    ('MaritalStatus', 'PlaceBirthCity'):    ['spousePlaceOfBirth', 'spouse_place_of_birth'],
    ('MaritalStatus', 'Occupation'):    ['spouseOccupation', 'spouse_occupation'],
    ('MaritalStatus', 'Email'):         ['spouseEmail', 'spouse_email'],
    # Parents
    ('Mother', 'FamilyName'):           ['motherLastName', 'mother_last_name'],
    ('Mother', 'GivenName'):            ['motherFirstName', 'mother_first_name'],
    ('Mother', 'PlaceBirthCountry'):    ['motherCountryOfBirth', 'mother_country_of_birth'],
    ('Mother', 'Citizenship'):          ['motherNationality', 'mother_nationality'],
    ('Father', 'FamilyName'):           ['fatherLastName', 'father_last_name'],
    ('Father', 'GivenName'):            ['fatherFirstName', 'father_first_name'],
    ('Father', 'PlaceBirthCountry'):    ['fatherCountryOfBirth', 'father_country_of_birth'],
    ('Father', 'Citizenship'):          ['fatherNationality', 'father_nationality'],
    # Previous spouse DOB
...
def extract_date_parts(data):
    ...
    date_fields = {
        ...
        'spouseDob': ('SpouseDOBYear', 'SpouseDOBMonth', 'SpouseDOBDay'),
        'motherDob': ('MotherDOBYear', 'MotherDOBMonth', 'MotherDOBDay'),
        'fatherDob': ('FatherDOBYear', 'FatherDOBMonth', 'FatherDOBDay'),
        'intendedEntryDate': ('EntryYYYY', 'EntryMM', 'EntryDD'),
        'usVisaExpiryDate': ('USVisaExpiryYYYY', 'USVisaExpiryMM', 'USVisaExpiryDD'),
    }
