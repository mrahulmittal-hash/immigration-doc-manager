...
import { Users, DollarSign, FileText, Building } from 'lucide-react';
  ...
  return (
    <div>
      <div style={{ marginBottom: 0 }}>
        ...
        <p style={{ fontSize: 13, color: 'var(--text-muted)', margin: 0 }}>Manage users, service fees, retainer templates, and firm profile</p>
      </div>
